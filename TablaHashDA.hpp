 ...
 *
 * La clase TablaHashDA implementa una tabla hash utilizando el m&eacute;todo de direccionamiento abierto.
 * Esto implica que los elementos se almacenan directamente en la tabla y se maneja la colisi&oacute;n
 * buscando la siguiente posici&oacute;n disponible.
 *
...
public:
    ...
    * \return true si el elemento fue agregado con &eacute;xito, false en caso contrario.
    */
    ...
    * \return true si el elemento fue eliminado con &eacute;xito, false en caso contrario.
    */
...
private:
    ...
    /**
     * \brief Funci&ocute;n hash para calcular el &iacute;ndice de un n&uacute;mero.
     * \param numero N&ucute;mero a calcular el &iacute;ndice.
     * \return &iacute;ndice calculado para el n&uacute;mero.
     */
    int funcionHash(int numero) const;
    /**
     * \brief Funci&ocute;n de sondeo para manejar colisiones.
     * \param hash &Iacute;ndice hash inicial.
     * \param i Intento de sondeo.
     * \return Nuevo &iacute; calculado despu&eacute;s del sondeo.
     */
    int sondeo(int hash, int i) const;
    /**
     * \brief Funci&ocute;n para rehashing de la tabla cuando est&acute; llena.
     */
    void rehash();
};
